...
# ========================== 路径配置 ==========================
label_path = "/data/zxli/M-BRe/NER/ontonotes_uf/test_data/test_label.txt"
entity_path = "/data/zxli/M-BRe/NER/ontonotes_uf/test_data/test_entity.txt"
sent_path  = "/data/zxli/M-BRe/NER/ontonotes_uf/test_data/test_sent.txt"
...
with open(label_path, 'r', encoding='utf-8') as f:
    ...
    labels = [literal_eval(line.strip()) for line in f]
