...
multi_prompt_list=[]
for i in range(0,9):
    file_path = '/data/zxli/M-BRe/NER/mult-prompt-grainedner-9/{}.txt'.format(i+1)
    print(file_path)
...
for i in range(0,len(grained_type)):
    file_path = '/data/zxli/M-BRe/NER/binary-prompt/{}.txt'.format(i+1)
    
    with open(file_path, 'r', encoding='utf-8') as file:
        binary_prompt_list.append(file.read())

def read_file():
    file_path = '/data/zxli/M-BRe/NER/bbn_afet/test_data/test_sent_filtered.txt'
    lines = []
...
def read_entity():
    file_path = '/data/zxli/M-BRe/NER/bbn_afet/test_data/test_entity_filtered.txt'
    entitys = []
...
def read_label():
    file_path = '/data/zxli/M-BRe/NER/bbn_afet/test_data/test_label_filtered.txt'
    labels = []
...
if __name__ == '__main__':
    ...
    with open('/data/zxli/M-BRe/NER/frame_pred/pred_labels.txt', 'w', encoding='utf-8') as file:
        for item in pred_labels:
            file.write("%s\n" % item) 

    with open('/data/zxli/M-BRe/NER/frame_pred/confidences-14B.txt', 'w', encoding='utf-8') as file:
        for item in Con:
            file.write("%s\n" % item) 
