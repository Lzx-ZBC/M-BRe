...
# 1. 路径
json_path = r"/data/zxli/M-BRe/NER/bbn_afet/train_data/train.json"
out_dir   = r"/data/zxli/M-BRe/NER/bbn_afet/train_data"

sent_file   = os.path.join(out_dir, "train_sent.txt")
entity_file = os.path.join(out_dir, "train_entity.txt")
label_file  = os.path.join(out_dir, "train_label.txt")
...
with open(json_path, "r", encoding="utf-8") as f:
    for line in f:
        ...
        for mention in sample.get("mentions", []):
            ...
            for lab in mention["labels"]:
                all_lines.append((sentence, entity, lab))
