...
def json_make_yes_or_no(): 
    with open('/data/zxli/M-BRe/NER/bbn_afet/train_sent.txt', 'r', encoding='utf-8') as f:
        sentences = [sentences.rstrip('\n') for sentences in f]

    with open('/data/zxli/M-BRe/NER/bbn_afet/train_entity.txt', 'r', encoding='utf-8') as f:
        fg_ner = [fg_ner.rstrip('\n') for fg_ner in f]

    with open('/data/zxli/M-BRe/NER/bbn_afet/train_label.txt', 'r', encoding='utf-8') as f:
        label = [label.rstrip('\n') for label in f]
...
Answer: No."""
    ...
    # print(prompt)
    filename = '/data/zxli/M-BRe/NER/binary-prompt/{}.txt'.format(i+1)
