...
"""
    ...
    output_dir = f"/data/zxli/kp/mult-prompt-tacred-cos/mult-prompt-tacred{n_groups}"
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    file_name = f"/data/zxli/kp/mult-prompt-tacred-cos/mult-prompt-tacred{n_groups}/{i+1}.txt"
