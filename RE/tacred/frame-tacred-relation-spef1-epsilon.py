...
multi_prompt_list=[]
for i in range(0,7):
    # file_path = '/data/zxli/kp/mult-prompt-tacred-cos/mult-prompt-tacred_kmeans7/{}.txt'.format(i+1)
    # file_path = '/data/zxli/kp/mult-prompt-tacred-cos/mult-prompt-tacred_hierarchical7/{}.txt'.format(i+1)
    file_path = '/data/zxli/kp/mult-prompt-tacred-cos/mult-prompt-tacred7/{}.txt'.format(i+1)
    print(file_path)
...
if __name__ == '__main__':
    ...
    with open('relation_pred_frame-class-qwen2.5-tacred-relation-random.txt', 'w', encoding='utf-8') as file:
        for item in relation_preds:
            file.write("%s\n" % item) 

    with open('confidences-14B.txt', 'w', encoding='utf-8') as file:
        for item in Con:
            file.write("%s\n" % item) 
